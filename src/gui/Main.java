...
//		ObjetDAO od = new ObjetDAO();
//		Objet o1 = new Objet("Les misérables Tome 2", "Victor Hugo", 11.95f, "Livre", 1, "1041427158");
//		Objet o2 = new Objet("Les misérables Tome 3", "Victor Hugo", 13.99f, "Livre", 1, "2322205508");
//		Objet o3 = new Objet("Les misérables Tome 4", "Victor Hugo", 15.99f, "Livre", 1, "2322207039");
//		Objet o4 = new Objet("Les misérables Tome 5", "Victor Hugo", 14.50f, "Livre", 1, "2013752121");
//		
//		od.create(o1);
//		od.create(o2);
//		od.create(o3);
